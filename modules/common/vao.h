...
public:
	...
	void Draw(int which, int mode = 0/* GL_TRIANGLES */);
	void DrawCount(int which, int count, int mode = 0/* GL_TRIANGLES */);
	void DrawInstances(int which, size_t instances, int mode = 0/* GL_TRIANGLES */);
